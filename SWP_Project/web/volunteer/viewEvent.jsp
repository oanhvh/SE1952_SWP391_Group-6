    ...
    <body>
        ...
        <div class="event-container">
            ...
            <div class="event-body">
                ...
                <c:if test="${not empty managerName}">
                    <div class="event-info"><span>Organization:</span>${managerName}</div>
                ...
                <div class="action-buttons">
                    <a href="${pageContext.request.contextPath}/volunteer/events" class="btn btn-secondary">
                    ...
                    <c:if test="${sessionScope.role == 'Volunteer' && event.status == 'Active'}">
                        <button type="button" class="btn btn-success"
                                onclick="openApplyForm(${event.eventID}, '${event.eventName}')">
                            Apply
                        </button>
                    </c:if>
                    <%--<c:if test="${sessionScope.role == 'Volunteer' && event.status == 'Active'}">
                        <a href="${pageContext.request.contextPath}/registration?eventId=${event.eventID}" class="btn btn-success">
        ...
        <div id="applyModal" class="modal">
            <div class="modal-content">
                ...
                <form id="applyForm" action="${pageContext.request.contextPath}/ApplyEventController" method="post">
                    ...
                    <div style="text-align:right; margin-top:10px;">
                        <button type="button" class="btn btn-secondary" onclick="closeApplyForm()">Cancel</button>
