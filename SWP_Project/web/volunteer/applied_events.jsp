    ...
    <body>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn-view"
                                    onclick="openModal('<%= va.getStaffComment().replace("'", "\\'") %>')">
                                Reject reason
                            </button>
                            <% } %>
                        </td>
        ...
        <div id="reasonModal" class="modal">
            <div class="modal-content">
                ...
                <h3 style="color:#1a237e;">Reason</h3>
                <p id="reasonText" style="color:#333; margin-top:10px;"></p>
            </div>
        </div>
