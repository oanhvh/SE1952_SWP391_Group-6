                ...
                <div class="container">
                    ...
                    <form action="ListAccount" method="get" class="search-section row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="searchName" name="name" class="form-control" placeholder="Enter user name"
                                   value="${param.name}">
                        </div>
                        <div class="col-md-4">
                            <label for="searchRole" class="form-label">Role</label>
                            <input type="text" id="searchRole" name="role" class="form-control" placeholder="Enter role"
                                   value="${param.role}">
                        </div>
                        <div class="col-md-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="viewAccountDetail" method="post" class="m-0">
                                                    ...
                                                    <button type="submit" class="btn btn-view btn-sm btn-primary">View Detail</button>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
