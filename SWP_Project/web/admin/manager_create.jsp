                    ...
                    <div class="col-12 col-lg-6 col-xl-5 d-flex justify-content-center">
                        <div class="card card-login w-100">
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${param.success == '1'}"><div class="alert alert-success mb-3">Manager account created successfully.</div></c:if>
                                <c:if test="${not empty param.error}"><div class="alert alert-danger mb-3">${fn:escapeXml(param.error)}</div></c:if>

                                    <form action="<%=request.getContextPath()%>/admin/manager_create" method="post">
                                    ...
                                    <!-- ================================================================================ -->
                                    <div class="mb-3">
                                        <label for="managerCode" class="form-label">Unit name</label>
                                        <input type="text" class="form-control" id="managerName" name="managerCode">
                                    </div>
                                    <div class="mb-3">
                                        <label for="department" class="form-label">contactInfo</label>
                                        <input type="text" class="form-control" id="contactInfo" name="department">
                                    </div>
                                    <div class="mb-3">
                                        <label for="position" class="form-label">address</label>
                                        <input type="text" class="form-control" id="position" name="address">
                                    </div>

                                    <div class="d-grid"><button type="submit" class="btn btn-primary">Create Manager</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
