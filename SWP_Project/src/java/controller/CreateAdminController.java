...
import service.CreateAdminService;
...
public class CreateAdminController extends HttpServlet {
    ...
    private final CreateAdminService createAdminService = new CreateAdminService();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean ok = createAdminService.registerAdmin(username, password, fullName, email, phone, null, errors);
        if (!ok) {
